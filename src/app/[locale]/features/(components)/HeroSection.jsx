...
const HeroSection = () => {
  return (
    <div className="flex flex-col justify-center gap-12 items-center lg:flex-row w-full lg:w-[80%] mx-auto my-[5%] lg:my-[10%]">
      <div className="w-full md:w-2/3 p-4">
        ...
        <div className="mx-auto flex justify-center lg:justify-start gap-4">
      ...
      <Img className="mx-auto w-2/3 md:w-1/3" src="/images/demo-img.png" width={515} />
    </div>
  );
};
